package
{
	...
	public class lowMoveableObstacle extends MovieClip
	{
		public var point1; 
		public var point2;
		public var point3;
		...
		public function lowMoveableObstacle()
		{
			Engine.lowMoveableObstacleList.push (this);
		}
		...
		// collision function below made to stop stack overflow when one low obst triggers another  
		public function collide2():void
		{
			for (var i:int = 0; i < Engine.lowMoveableObstacleList.length; i++)
				{
					...
					if (Engine.lowMoveableObstacleList[i] != this && Engine.lowMoveableObstacleList[i].alpha == 100 && hitTestObject(Engine.lowMoveableObstacleList[i]))
					{
						...
						Engine.lowMoveableObstacleList[i].collide3();
					}	
				}
			...
			for (var i:int = 0; i < Engine.lowMoveableObstacleList.length; i++)
				{
					...
					if (Engine.lowMoveableObstacleList[i] != this && Engine.lowMoveableObstacleList[i].alpha == 100 && hitTestObject(Engine.lowMoveableObstacleList[i]))
					{
						...
						Engine.lowMoveableObstacleList[i].collide4();
					}	
				}
			...
			for (var i:int = 0; i < Engine.lowMoveableObstacleList.length; i++)
				{
					...
					if (Engine.lowMoveableObstacleList[i] != this && Engine.lowMoveableObstacleList[i].alpha == 100 && hitTestObject(Engine.lowMoveableObstacleList[i]))
					{
						...
						Engine.lowMoveableObstacleList[i].collide5();
					}	
				}
			...
			for (var i:int = 0; i < Engine.lowMoveableObstacleList.length; i++)
				{
					...
					if (Engine.lowMoveableObstacleList[i] != this && Engine.lowMoveableObstacleList[i].alpha == 100 && hitTestObject(Engine.lowMoveableObstacleList[i]))
					{
						...
						//Engine.lowMoveableObstacleList[i].collide6();
					}	
				}
			...
			for (var i:int = 0; i < Engine.lowMoveableObstacleList.length; i++)
				{
					...
					if (Engine.lowMoveableObstacleList[i] != this && Engine.lowMoveableObstacleList[i].alpha == 100 && hitTestObject(Engine.lowMoveableObstacleList[i]))
					{
						...
						Engine.lowMoveableObstacleList[i].collide2();
					}	
				}
